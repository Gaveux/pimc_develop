...
C
C      Implementation from http://comp.chem.umn.edu/potlib/index.html
C      Need to cite them
...
c                  ALL UNITS ARE IN au,i.e., bohr, radian and hartree. YU
  ...
  111  format(/1x,'pes for ch4: fast version')
       open(unit=1,file='ch4pes',form='formatted',status='old')
      read(1,1492)title                                                 8d1s00
 1492 format(a80)                                                       8d1s00
      write(6,*)('title for PES:')                                      8d1s00
      write(6,1492)title                                                8d1s00
      ...
      a03=a03*4d0
      a04=a04*4d0
!     write(6,*)('zero order fit parameters: ')
!     write(6,*)('re0,ex0,beta0 '),re0,ex0,beta0
!     write(6,*)('r0i '),r01,r02,r03,r04
!     write(6,*)('a0i '),a02,a03,a04,a06,a08                            8d3s00
c      call flush(6)
...
!      write(6,*)('re = '),re
!      write(6,*)('stretch morse parameter '),ex
!      write(6,*)('bend extrapolation parameter '),exa
!      write(6,*)('damping parameter = '),beta                          6d15s00
!      write(6,*)('iradau = '),iradau                                   6d19s00
!      write(6,*)('lm = '),lm                                           6d19s00
       tocm=1d0/4.556335d-6                                              5d23s91
       sr12=sqrt(1d0/12d0)
       srh=sqrt(0.5d0)
       nexp=0
...
!        write(6,*)('pure stretch power: '),i1,coef
         cs(i1)=coef*6d0
         ix1=max(ix1,i1)
         coef=0d0                                                       6d13s00
        else if(j2.eq.0.and.lm.ne.0)then                                6d23s00
!        write(6,*)('pure bend power: '),i2,coef
         cb(i2)=coef*4d0
         ix2=max(ix2,i2)
         coef=0d0                                                       6d13s00
        end if                                                          6d13s00
         ...
         ix(nexp,9)=i9
         cc(nexp)=coef
!        write(6,3)nexp,(ix(nexp,j),j=1,9),cc(nexp)
...
c$$$        cc(i)=cc(i)*energy
    ...
    5  continue
       thrd=1d0/3d0
       close(unit=1)
!       write(6,*)('analyzing fcns for numbers of multiplications ')
       nx(1)=0                                                             5d30s00
       nx(2)=0                                                             5d30s00
       nx(3)=0                                                             5d30s00
       nx(4)=0                                                             5d30s00
...
!      write(6,*)('number of fcns with zero nonzero: '),nxzero          7d24s00
!      write(6,*)('number of fcns with one nonzero: '),nx(1)
!      write(6,*)('number of fcns with two nonzero: '),nx(2)
!      write(6,*)('number of fcns with three nonzero: '),nx(3)
!      write(6,*)('number of fcns with four nonzero: '),nx(4)
!      write(6,*)('number of fcns with five nonzero: '),nx(5)
!      write(6,*)('number of fcns with six nonzero: '),nx(6)
!      write(6,*)('number of fcns with seven nonzero: '),nx(7)
!      write(6,*)('number of fcns with eight nonzero: '),nx(8)
       return
       end
